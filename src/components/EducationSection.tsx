...
export const EducationSection: React.FC = () => {
  return (
    <section id="education" className="py-16 relative bg-slate-950/80 border-t border-slate-800/80 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400 leading-relaxed mb-4">
                    Öğrenim Süresi: <b>2022 – 2026</b>. Nesne Yönelimli Programlama, Veri Yapıları & Algoritmalar, Veritabanı Sistemleri, Yazılım Mühendisliği ve Test Otomasyonu konularında güçlü teorik ve pratik temeller.
                  </p>
          ...
          >
            <SpotlightCard className="p-8 h-full" spotlightColor="rgba(139, 92, 246, 0.15)">
              <div className="flex items-start gap-5">
